...
export const Dashboard = () => {
    ...
    return (
        <div>
            <HeadTitle
                title={"Dashboard"}
                subTitle={"Monitor your room listings, track bookings and analyze revenue-aall in one place. Stay update with real-time insights to ensure smooth operations."}
            />
