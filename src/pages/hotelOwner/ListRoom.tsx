...
export const ListRoom = () => {
    ...
    const handleToggleAvailability = (roomId: string | number) => {
        setRooms((prevRooms) =>
            prevRooms.map((room) =>
    ...
    return (
        <div>
            <HeadTitle title={"Room Listings"} subTitle={"View, edit, or manage all listed rooms. Keep the information up-to-date to provide the best experience for users."} />
